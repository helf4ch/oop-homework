...
public class ArrayList<T> implements List<T>, Iterable<T> {
    ...
    private class ArrayListIterator<Z> implements Iterator<Z> {
        
        private int currentPosition;
        private int size;
        private ArrayList<Z> iterableArrayList;

        public ArrayListIterator(ArrayList<Z> iterableArrayList, int size) {
        ...
        @Override
        public Z next() {
            return this.iterableArrayList.get(++currentPosition);
        }
    }
    ...
    public Iterator<T> iterator() {
        return new ArrayListIterator<T>(this, this.size);
    }
}
